...
<head>
    ...
    <link rel="stylesheet" href="css/learn-guitar.css">
...
<body>
  ...
  <section class="parallax home" id="home" style="height: 580px; background-image: url(foto/bg-piano.svg);">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle"  style="color: #ECC179;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Learn
                </a>
  ...
  <section style="height: 1600px;">
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <div class="carousel">
          <a href="detail-piano.php">
            <img src="foto/play-piano1.svg" alt="img">
          </a>
            <img src="foto/play-piano1.svg" alt="img">
            <img src="foto/play-piano1.svg" alt="img">
            <img src="foto/play-piano1.svg" alt="img">
      ...
      <div class="wrapper">
        <i id="left" class="fas fa-angle-left"></i>
        <div class="carousel">
          <img src="foto/play-piano2.svg" alt="img">
          <img src="foto/play-piano2.svg" alt="img">
          <img src="foto/play-piano2.svg" alt="img">
          <img src="foto/play-piano2.svg" alt="img">
          <img src="foto/play-piano2.svg" alt="img">
      ...
      <div class="wrapper">
        <i id="left" class="fas fa-angle-left"></i>
        <div class="carousel">
          <img src="foto/play-piano3.svg" alt="img">
          <img src="foto/play-piano3.svg" alt="img">
          <img src="foto/play-piano3.svg" alt="img">
          <img src="foto/play-piano3.svg" alt="img">
          <img src="foto/play-piano3.svg" alt="img">
